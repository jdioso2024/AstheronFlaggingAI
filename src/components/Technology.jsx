            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="h-[280px] bg-[#161b22] border border-[#283039] rounded-xl p-4 overflow-hidden relative group hover:border-blue-500/30 transition-colors">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="h-[280px] bg-[#161b22] border border-[#283039] rounded-xl p-4 overflow-hidden relative group hover:border-blue-500/30 transition-colors">
                            <div className="bg-[#0f1318] rounded-lg border border-[#283039] p-4 h-full flex flex-col justify-center items-center relative">
                                <div className="flex flex-wrap gap-2 justify-center max-w-[220px] mb-8">
