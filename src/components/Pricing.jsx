        ...
        <section id="pricing" className="py-24 px-6 bg-[#111418] relative">
            ...
            <div className="max-w-[900px] mx-auto flex flex-col items-center">
                ...
                <div className="w-full rounded-2xl border border-[#283039] bg-[#101922] p-8 md:p-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <a href="https://wa.me/#" target="_blank" rel="noopener noreferrer" className="whitespace-nowrap flex items-center gap-2 px-6 py-3 rounded-lg bg-white text-black font-bold hover:bg-slate-200 transition-colors shadow-lg shadow-white/10">
                        Contact Sales
